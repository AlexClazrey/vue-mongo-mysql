...
-- Table `bforum`.`file`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`file` ;
...
-- Table `bforum`.`user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`user` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`post_content` ;
...
-- Table `bforum`.`post`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`post` ;
...
-- Table `bforum`.`board`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`board` ;
...
-- Table `bforum`.`mail`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`mail` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`mailbox` ;
...
-- Table `bforum`.`group`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`group` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`privilege` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`post_to_board` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`post_to_file` ;
...
-- Table `bforum`.`reply`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`reply` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`favorite_post` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`commit_post` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`history_post` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`draft_post` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`like_post` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`pick_post` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`top_post` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`protect_post` ;
...
-- Table `bforum`.`at`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`at` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`user_to_mailbox` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`user_to_group` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`blacklist` ;
...
-- Table `bforum`.`follow`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`follow` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`group_to_privilege` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`mail_to_mailbox` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bforum`.`cookies` ;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`user_register`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`add_board`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`add_post`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`commit_post`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`add_post_to_board`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`edit_post`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`get_post_board`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`add_post_to_reply`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`user_login`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`add_cookies`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`add_group`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`add_privilege`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`add_privilege_to_group`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`add_user_to_group`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`check_cookies`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`check_privilege`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`update_cookies`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`draft_post`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`edit_draft`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`delete_cookies`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`save_draft`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`change_post_to_board`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`change_post_to_reply`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`delete_post_user`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`delete_post_admin`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`delete_draft`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`delete_user_admin`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`delete_user_from_group`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`delete_privilege_from_group`;

DELIMITER $$
USE `bforum`$$
CREATE PROCEDURE `delete_privilege_from_group` (in _gid int, in _pri_id int)
BEGIN
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`delete_group`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`delete_privilege`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`add_fav_post`;
...
USE `bforum`;
DROP procedure IF EXISTS `bforum`.`delete_fav_post`;
...
DROP VIEW IF EXISTS `bforum`.`v_user_mail_core` ;
USE `bforum`;
...
DROP VIEW IF EXISTS `bforum`.`v_user_mail_count_all` ;
USE `bforum`;
...
DROP VIEW IF EXISTS `bforum`.`v_user_privilege_core` ;
USE `bforum`;
...
DROP VIEW IF EXISTS `bforum`.`v_user_privilege` ;
USE `bforum`;
...
DROP VIEW IF EXISTS `bforum`.`v_user_mail_count_by_box` ;
USE `bforum`;
...
DROP VIEW IF EXISTS `bforum`.`v_user_mail` ;
USE `bforum`;
...
DROP VIEW IF EXISTS `bforum`.`v_ubp_core` ;
USE `bforum`;
...
DROP VIEW IF EXISTS `bforum`.`v_post_pick` ;
USE `bforum`;
...
DROP VIEW IF EXISTS `bforum`.`v_post_top` ;
USE `bforum`;
...
DROP VIEW IF EXISTS `bforum`.`v_post_protect` ;
USE `bforum`;
...
DROP VIEW IF EXISTS `bforum`.`v_post_addon` ;
USE `bforum`;
...
DROP VIEW IF EXISTS `bforum`.`v_post_content` ;
USE `bforum`;
...
DROP VIEW IF EXISTS `bforum`.`v_post_reply_content` ;
USE `bforum`;
...
DROP VIEW IF EXISTS `bforum`.`v_post_reply_list` ;
USE `bforum`;
...
DROP VIEW IF EXISTS `bforum`.`v_post_board` ;
USE `bforum`;
...
DROP VIEW IF EXISTS `bforum`.`v_post_reply_time` ;
USE `bforum`;
...
DROP VIEW IF EXISTS `bforum`.`v_ubp_list` ;
USE `bforum`;
